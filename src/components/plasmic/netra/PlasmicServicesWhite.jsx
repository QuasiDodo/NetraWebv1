...
import * as sty from "./PlasmicServicesWhite.module.css" // plasmic-import: v9iiG2M953HZOc/css
...
function PlasmicServicesWhite__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ltpCl)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__ustgt)}
              role={"img"}
            />
          ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qpRTu)}
      >
        <h3
