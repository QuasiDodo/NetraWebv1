...
import * as sty from "./PlasmicCaseStudiesWraper.module.css" // plasmic-import: WpjxXuLMQkn-2l/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__loE34)}
            displayHeight={"auto"}
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button__nDn6F)}
                color={"blackCoffee"}
              >
                <div
                  className={classNames(
